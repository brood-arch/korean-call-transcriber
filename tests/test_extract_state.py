"""Tests for src.extract.state — processed index, checkpoints, TODO sync."""
...
class TestProcessedIndex:
    def test_load_empty_returns_empty_dict(self, tmp_path):
        from src.extract.state import load_processed_index
    ...
    def test_save_and_reload(self, tmp_path):
        from src.extract.state import load_processed_index, save_processed_index
...
class TestCheckpoint:
    def test_load_no_checkpoint_returns_zero(self, tmp_path):
        from src.extract.state import load_checkpoint
    ...
    def test_today_only_resets_if_stale(self, tmp_path):
        ...
        with patch("src.extract.state.datetime") as mock_dt:
    ...
    def test_save_and_load_roundtrip(self, tmp_path):
        from src.extract.state import load_checkpoint, save_checkpoint
...
class TestBatchResult:
    def test_save_batch_result_creates_file(self, tmp_path):
        from src.extract.state import save_batch_result
...
class TestNotificationState:
    def test_load_empty_creates_buckets(self, tmp_path):
        from src.extract.state import load_notification_state
    ...
    def test_save_and_reload(self, tmp_path):
        from src.extract.state import load_notification_state, save_notification_state
...
class TestAppointmentKey:
    def test_key_format(self):
        from src.extract.state import appointment_key
