"""Tests for kct.pipeline.utils — atomic writes, compression, JSON helpers."""
...
class TestSafeSaveJson:
    ...
    def test_corrupt_file_returns_default(self, tmp_path):
        from kct.pipeline.utils import safe_load_json
...
class TestCompressTranscript:
    def test_shortens_long_transcript(self):
        from kct.pipeline.utils import compress_transcript
...
class TestFallbackSummary:
    def test_generates_basic_summary(self):
        from kct.pipeline.utils import fallback_summary
