...
Usage:
    python -m kct.sync.sync_obsidian [--all] [--dry-run]
    python -m kct.sync.sync_obsidian --all --dry-run   # 전체 재처리 시뮬레이션
...
from kct.config import OBSIDIAN_VAULT, STATE_DIR
from kct.config import TRANSCRIPT_DIR as SOURCE_DIR
from kct.pipeline.utils import safe_save_json, safe_write_text
